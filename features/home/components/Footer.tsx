...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-col bg-solar-dark text-muted/50 text-start px-8 py-16 text-sm">
      <div className="lg:flex lg:flex-row lg:justify-around lg:gap-x-12 lg:items-start space-y-6 ">
