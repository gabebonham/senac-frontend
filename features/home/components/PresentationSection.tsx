...
export default function PresentationSection() {
  ...
  return (
    <section
      ...
      bg-cover bg-center py-4 flex flex-col gap-y-8 px-8
      shadow-[inset_0_0_220px_rgba(0,0,0,0.9)]"
    >
      <div className="w-full flex justify-center items-center ">
        <div className="w-full wrap-break-word h-full bg-transparent border-1 py-2 px-4 rounded-full border-solar-light text-solar-light flex items-center gap-x-2 bg-gradient-to-r from-solar-light/30 to-solar-dark/10">
          <Sun />
      ...
      <div className="flex flex-col gap-y-8">
        <Button className="w-full h-12 rounded-xl text-lg bg-linear-to-r from-sun to-solar-glow-dark">
          Simular Economia Agora
        </Button>
        <Button className="w-full h-12 rounded-xl text-lg bg-transparent border-white border-1">
